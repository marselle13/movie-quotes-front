    ...
    <div class="relative">
      <Field :name="id" :rules="rules" v-slot="{ field, meta }">
        <input
          ...
          class="text-[#212529] placeholder:text-[#6C757D] rounded px-3 py-2 w-full bg-[#CED4DA] border-2 outline-none focus:shadow-[0px_0px_0px_4px] focus:shadow-[#0d6efd3b] disabled:text-[#6C757D] disabled:text-opacity-30 disabled:bg-[#E9ECEF]"
          :class="{
