  ...
  generateMessage: localize({
    en: {
      ...
      messages: {
        ...
        eng_chars: '{field} must only contain English characters',
        geo_chars: '{field} must only contain Georgian characters',
    ...
    ka: {
      ...
      names: {
        ...
        genres: 'ჟანრი',
        year: 'წელი',
        directorEng: 'რეჟისორის სახელი',
        directorGeo: 'რეჟისორი სახელი',
      ...
      messages: {
        ...
        eng_chars: '{field} უნდა შეიცავდეს ინგლისურ სიმბოლოებს',
        geo_chars: '{field} უნდა შეიცავდეს ქართულ სიმბოლოებს',
